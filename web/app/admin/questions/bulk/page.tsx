...
import { validateQuestionsPayload, type QuestionBulkItem, type ValidationError } from "./components/validation";
...
export default function QuestionBulkPage() {
  ...
  const [previewItems, setPreviewItems] = useState<QuestionBulkItem[]>([]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = validateQuestionsPayload(json);
      ...
      <Section>
        <Flex direction="column" gap="4" className="mx-auto max-w-3xl">
          <Card variant="classic">
            ...
            <Text color="gray">JSONファイルで問題をまとめて登録します。上限は300件です。</Text>
            <Flex direction="column" gap="2" mt="4">
              <Flex align="center" gap="2">
                <Badge color="red">必須</Badge>
                <Text size="2" color="gray">
                  questionType, prompt, correctAnswer
                </Text>
              </Flex>
              <Flex align="center" gap="2">
                <Badge color="gray">任意</Badge>
                <Text size="2" color="gray">
                  choices, explanation, difficulty, tags, order
                </Text>
              </Flex>
              <Text size="2" color="gray">
