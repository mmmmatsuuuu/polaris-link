...
import type { SubjectBulkItem, ValidationError } from "./validation";
        ...
        <Box mt="2">
          ...
          <Box mt="3">
            {previewItems.map((item, index) => (
              <Box key={`${item.name}-${index}`} className="rounded-md border border-slate-200 bg-white px-3 py-2">
                <Flex gap="3" mt="1">
