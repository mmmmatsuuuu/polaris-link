...
import { validateLessonsPayload, type LessonBulkItem, type ValidationError } from "./components/validation";
...
export default function LessonBulkPage() {
  ...
  const [previewItems, setPreviewItems] = useState<LessonBulkItem[]>([]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = validateLessonsPayload(json);
      ...
      const items = result.data?.lessons ?? [];
