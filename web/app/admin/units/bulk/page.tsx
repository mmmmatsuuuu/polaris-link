...
import { SubjectListDrawer } from "./components/SubjectListDrawer";
import { StatusPanel } from "./components/StatusPanel";
import { validateUnitsPayload, type UnitBulkItem, type ValidationError } from "./components/validation";
...
export default function UnitBulkPage() {
  ...
  const [previewItems, setPreviewItems] = useState<UnitBulkItem[]>([]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = validateUnitsPayload(json);
      ...
      <Section>
        <Flex direction="column" gap="4" className="mx-auto max-w-3xl">
          <Card variant="classic">
            ...
            <Text color="gray">JSONファイルで単元をまとめて登録します。上限は300件です。</Text>
