...
import { validateStudentsPayload, type StudentBulkItem, type ValidationError } from "./components/validation";
...
export default function StudentBulkPage() {
  ...
  const [previewItems, setPreviewItems] = useState<StudentBulkItem[]>([]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = validateStudentsPayload(json);
      ...
      const items = result.data?.students ?? [];
      ...
      <Section>
        <Flex direction="column" gap="4" className="mx-auto max-w-3xl">
          <Card variant="classic">
            ...
            <Text color="gray">JSONファイルで生徒をまとめて登録します。上限は300件です。</Text>
            <Flex direction="column" gap="2" mt="4">
              ...
              <Flex align="center" gap="2">
                ...
                <Text size="2" color="gray">
                  displayName, studentNumber, notes
                </Text>
              </Flex>
            </Flex>
