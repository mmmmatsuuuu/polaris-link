...
- [ ] **全ページと主要コンポーネントの作成**:
  - [ ] `DESIGN.md` に基づき、すべての画面（生徒用ダッシュボード、授業ページ、コンテンツ表示、学習分析、教師用ダッシュボード、科目・単元・授業管理、コンテンツ管理、生徒利用状況分析、CSVアップロード、Playground）のNext.jsページファイルを作成します。
  - [ ] 各ページに必要な主要なコンポーネント（例: 科目カード、授業リスト、コンテンツプレイヤーのシェル、クイズフォームのシェル、分析グラフのプレースホルダーなど）を、機能を持たせずに表示のみ実装します。
  - [ ] 共通レイアウト（ヘッダー、サイドバー、フッター）との連携を確認します。
